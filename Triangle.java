public class Triangle{
  ...
  public String classify(){
    double side1 = (Math.round(1000.0*v1.distanceTo(v2))/ 1000.0);
    double side2 = (Math.round(1000.0*v2.distanceTo(v3))/ 1000.0);
    double side3 = (Math.round(1000.0*v3.distanceTo(v1))/ 1000.0);
    if (side1==side2){
      if (side2==side3){
        return "equilateral";
      }
